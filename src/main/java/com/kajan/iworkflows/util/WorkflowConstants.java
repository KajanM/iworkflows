...
public class WorkflowConstants {
    ...
    // leave process constants
    public static final String LEAVE_DETAILS_KEY = "leave_details";
    public static final String LEAVE_PROCESS_DEFINITION_KEY = "leave_process";
